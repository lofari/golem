...
func (gs *GolemServer) ListTools() []string {
	...
	return []string{"mark_task", "set_phase", "set_status", "add_decision", "add_pitfall", "add_locked", "log_session", "find_callers", "find_dependencies", "find_dependents", "graph_query", "semantic_search", "find_co_changed", "find_execution_failures", "get_runtime_trace", "find_test_results"}
}
